...
import L_NuCampSite from "../../assets/img/projects/nucampsite.png"
                        ...
                        <div className="d-flex justify-content-between flex-column mt-1">
                            <div>
                                ...
                                <Card>
                                    ...
                                    <Accordion.Collapse eventKey="0" className="text-left">
                                    <Card.Body>
                                        <strong>Description:</strong> This is a mock website, created to learn how to use developmental tools.
                                        <hr />
                                        <strong>Features:</strong>
                                        <ul className="list-styles pt-1">
                                            <li>Powered by Bootstrap.</li>
                                            <li>Managed by Redux</li>
                                        </ul>
                                        <hr />
                                        <strong>Tech used:</strong>
                                        <ul>
